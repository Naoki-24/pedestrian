...
from models import action_prediction
...
def run(config_file=None):
    ...
    for dataset_idx, dataset in enumerate(model_configs['exp_opts']['datasets']):
        ...
        saved_files_path = method_class.train(beh_seq_train, beh_seq_val, **configs['train_opts'], model_opts=configs['model_opts'])

        # saved_files_path = method_class.optimizing_train(beh_seq_train, beh_seq_test, beh_seq_val, **configs['train_opts'], model_opts=configs['model_opts'])
